...
public class BlackJackUINew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jYourTurn = new javax.swing.JLabel();
        ...
        jYourTurn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PokerCardImage/white.png"))); // NOI18N
        jAllCards.add(jYourTurn);
        jYourTurn.setBounds(434, 144, 50, 50);
    ...
    public void EnableYourTurn() {
        jYourTurn.setVisible(true);
        /*if (turn == 0) {
            turn = 1;
            //System.out.println("Image " + new ImageIcon("PokerCardImage/white.png"));
            jYourTurn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PokerCardImage/white.png")));
        } else if (turn == 1) {
            turn = 0;
            jYourTurn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PokerCardImage/grey.png")));
        }*/
    }
    ...
    public void SendCardToPosition(PlayerInfo Player, boolean roundend) {
        ...
        if (Player.getposition() == Players[myposition].getposition()) {
            ...
            if ((Player.getCardsInfo()[current_index].gethide() == 1) && (roundend == false)) {
                //System.out.println(getClass().getResource("/PokerCardImage/Back.png"));
    ...
    private javax.swing.JLabel jYourTurn;
